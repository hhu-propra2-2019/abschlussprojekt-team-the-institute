...
public class FakeHttpClient implements IHttpClient {
  ...
  @Override
  public String post(String url, String requestBody, HttpHeaders headers) throws HttpClientErrorException {
    return fakeResponse(url);
  }
   ...
   * @return The response
   * @throws HttpClientErrorException if the fakeStatusCode is set to an error status code (4xx or 5xx)
   */
